...
public class ChatActivity extends AppCompatActivity {
    ...
    public void sends(){
        ...
        if (message.length() > 0) {
        reference1.child("Chat").child("user1").child("user2").push()
        ...
        reference2.child("Chat").child("user2").child("user1").push()
    ...
    public void tampil(){
        reference1.child("Chat").child("user1").child("user2").addValueEventListener(new ValueEventListener() {
            @Override
